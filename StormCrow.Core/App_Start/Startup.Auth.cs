...
namespace StormCrow.Core
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //app.CreatePerOwinContext<ApplicationUserManager>(() => new ApplicationUserManager());
            //app.CreatePerOwinContext<ApplicationSignInManager>(() => new ApplicationSignInManager());
